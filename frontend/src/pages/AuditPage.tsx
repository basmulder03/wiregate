  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">System activity and access history</p>
      </div>

      <div className="bg-white rounded-xl border border-gray-200">
        <div className="px-5 py-4 border-b border-gray-100 flex items-center gap-2">
          <ClipboardList className="w-4 h-4 text-gray-500" />
          <span className="font-medium text-gray-900">Recent Events</span>
          {logs && (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Resource</th>
